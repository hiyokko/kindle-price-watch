...
const defaultStore = {
  ...
  automation: {
    ...
    lastNewReleaseFollowUpQueued: 0,
    lastNewReleaseFollowUpChecked: 0,
    lastNewReleaseFollowUpSucceeded: 0,
    lastNewReleaseFollowUpFailed: 0,
    lastNewReleaseFollowUpAsins: [],
