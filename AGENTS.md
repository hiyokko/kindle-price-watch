...
- Keep Vercel Git auto-deploy integration disabled for this project. Use GitHub for source sync, then deploy production explicitly with the Vercel CLI after pushing `main`.
